---
title: Dependencies
description: Build-time and optional runtime tools and how to install them
---
...
your project's `.rosewood.toml` — see [Configuration](/docs/guides/configuration/#debugging).
